            ...
            <div className="navbar-container"> {/* Voeg deze regel toe */}
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto">
                        <button type="button" className="btn btn-outline-primary"><i className="bi bi-house-fill"></i> Home</button>
                        <button type="button" className="btn btn-outline-primary"><i className="bi bi-people-fill"></i> Patiëntenoverzicht</button>
                        <button type="button" className="btn btn-outline-primary"><i className="bi bi-file-check-fill"></i> Resultaten</button>
                        <button type="button" className="btn btn-outline-primary"><i className="bi bi-calendar-event-fill"></i> Kalender</button>
                    </ul>
