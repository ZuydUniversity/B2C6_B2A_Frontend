            ...
            <div className="navbar-container">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto">
                        <Link to="/DoctorDashboard" type="button" className="btn btn-outline-primary"><i className="bi bi-house-fill"></i> Home</Link>
                ...
                <ul className="navbar-nav ms-auto">
                    ...
                    <div className="dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <Link to="/ProfilePage" className="dropdown-item" href="#"><i className="bi bi-person-fill-gear"></i> Profielinstellingen</Link>
